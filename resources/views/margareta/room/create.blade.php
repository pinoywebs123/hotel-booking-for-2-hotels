    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <ul class="nav nav-tabs">
              <li role="presentation" ><a href="{{route('margareta_rooms')}}">List</a></li>
              <li role="presentation" class="active"><a href="{{route('margareta_rooms_create')}}">Create</a></li>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="col-md-6">
                  ...
                  <form action="{{route('margareta_create_check')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  @endif
                  <h3>New Rooms</h3>
                  <form action="{{route('margareta_room_in_cat')}}" method="POST">
                    <div class="form-group">
