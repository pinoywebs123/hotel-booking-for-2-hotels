                  ...
                  <tbody>
                   @foreach($persons as $morl)
                    <tr>
                      ...
                      <TD>{{$morl->position}}</TD>
                      <td>
                        <a href="{{route('margareta_payment_personnel_delete', ['id'=> $morl->id])}}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                      </td>
                    </tr>
                   @endforeach
         ...
         <div class="modal-dialog">
           <div class="modal-content">
             ...
             <div class="modal-body">
               <form action="{{route('margareta_payment_personnel_check')}}" method="POST">
