...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-6">
      <h1 class="ac">Margareta</h1>
      <div id="container">
        <div class="item">
          <img class="ac hotel-img" src="{{URL::to('image/margareta.jpg')}}">
        </div>
      </div>
      <br><a href="{{route('login')}}" class="ac btn btn-default btn-lg">Book</a>
    </div>
    <div class="col-sm-6">
      <h1 class="ac">Velez</h1>
      <div id="container">
        <div class="item">
          <img class="ac hotel-img" src="{{URL::to('image/velez.jpg')}}">
        </div>
      </div>      
      <br><a href="{{route('login')}}" class="ac btn btn-default btn-lg">Book</a>
    </div>
